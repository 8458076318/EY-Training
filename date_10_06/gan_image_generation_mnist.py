...
class Generator(nn.Module):
  def __init__(self, z_dim):
    ...
    self.model = nn.Sequential(
        ...
        nn.BatchNorm2d(128),
        nn.ReLU(),
        nn.ConvTranspose2d(128, 64, 4, 2, 1), # Input 14x14, Output 28x28
        nn.BatchNorm2d(64),
        nn.ReLU(),
        nn.ConvTranspose2d(64, 1, 4, 2, 1), # Input 28x28, Output 56x56
        nn.Tanh(),
    )
  def forward(self, x):
      return self.model(x)
...
def show_images(fake):
  ...
  grid = img.view(16, image_size, image_size)
...
for epoch in range(epochs):
  for real, _ in dataloader:
    ...
    # The discriminator now learns from 56x56 images instead of 28x28.
